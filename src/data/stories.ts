import Floresta from "./../assets/images/historias-images/Floresta.jpg";
import MarEstrelas from "./../assets/images/historias-images/Mar-Estrelas.jpg";
...
const stories: Story[] = [
	{
		...
		description:
			"Uma aventura mágica em uma floresta cheia de surpresas e criaturas fantásticas",
		coverImage: Floresta,
		initialScene: "inicio",
		scenes: [
			{
	...
	},
	{
		...
		description:
			"Uma aventura no fundo do oceano onde as estrelas-do-mar guardam segredos mágicos",
