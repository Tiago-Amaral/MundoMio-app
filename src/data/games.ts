import bola from "./../assets/images/games-images/bola.png";
import casa from "./../assets/images/games-images/casa.png";
import arvore from "./../assets/images/games-images/arvore.png";
import flor from "./../assets/images/games-images/flor.png";
import cachorro from "./../assets/images/games-images/cachorro.png";
import peixe from "./../assets/images/games-images/peixe.png";
import sol from "./../assets/images/games-images/sol.png";
import gato from "./../assets/images/games-images/gato.png";
import lua from "./../assets/images/games-images/lua.png";
import rato from "./../assets/images/games-images/rato.png";
import sapo from "./../assets/images/games-images/sapo.png";
import pe from "./../assets/images/games-images/pé.png";
import mao from "./../assets/images/games-images/mão.png";
import pato from "./../assets/images/games-images/pato.png";
...
export const quizQuestions: QuizQuestion[] = [
	{
		question:
			'Na história "A Floresta Encantada", quem ajuda o personagem principal?',
		options: [
			"Uma bruxinha",
			"Uma fadinha chamada Lila",
			"Um coelho falante",
			"Um duende verde",
		],
		correctAnswer: 1,
	...
	{
		question:
			'Na história "O Mar de Estrelas", o que o personagem encontrou na praia?',
		options: [
			"Uma concha mágica",
			"Uma garrafa com mensagem",
			"Uma estrela-do-mar brilhante",
			"Um barquinho pequeno",
		],
		correctAnswer: 2,
